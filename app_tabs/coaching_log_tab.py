# tabs/coaching_log_tab.py
# app.py에서 tabs 패키지를 통해 자동으로 import됩니다.
# 직접 호출 시: from tabs import render_coaching_log_tab
#
# ※ coachee_id_default: 사이드바의 emp_id를 그대로 넘기면
#    팀원 사번 필드에 자동으로 채워집니다.
